...
extern "C" {
  ...
  extern char * pshmem_version(void) _WUR;
  ...
  extern void * pshmem_short_put_nb(short *dest, const short *src, size_t len, int pe) _WUR;
  extern void * pshmem_int_put_nb(int *dest, const int *src, size_t len, int pe) _WUR;
  extern void * pshmem_long_put_nb(long *dest, const long *src, size_t len, int pe) _WUR;
  extern void * pshmem_longlong_put_nb(long long *dest, const long long *src, size_t len, int pe) _WUR;
  extern void * pshmem_longdouble_put_nb(long double *dest, const long double *src, size_t len, int pe) _WUR;
  extern void * pshmem_double_put_nb(double *dest, const double *src, size_t len, int pe) _WUR;
  extern void * pshmem_float_put_nb(float *dest, const float *src, size_t len, int pe) _WUR;
  extern void * pshmem_putmem_nb(void *dest, const void *src, size_t len, int pe) _WUR;
  extern void * pshmem_put32_nb(void *dest, const void *src, size_t len, int pe) _WUR;
  extern void * pshmem_put64_nb(void *dest, const void *src, size_t len, int pe) _WUR;
  extern void * pshmem_put128_nb(void *dest, const void *src, size_t len, int pe) _WUR;
