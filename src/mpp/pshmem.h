...
extern "C" {
  ...
  extern void   pshmem_short_put(short *dest, const short *src, size_t nelems, int pe);
  extern void   pshmem_int_put(int *dest, const int *src, size_t nelems, int pe);
  extern void   pshmem_long_put(long *dest, const long *src, size_t nelems, int pe);
  extern void   pshmem_longlong_put(long long *dest, const long long *src, size_t nelems, int pe);
  extern void   pshmem_longdouble_put(long double *dest, const long double *src, size_t nelems, int pe);
  extern void   pshmem_double_put(double *dest, const double *src, size_t nelems, int pe);
  extern void   pshmem_complexd_put(COMPLEXIFY(double) *dest, const COMPLEXIFY(double) *src, size_t nelems, int pe);
  extern void   pshmem_float_put(float *dest, const float *src, size_t nelems, int pe);
  extern void   pshmem_putmem(void *dest, const void *src, size_t nelems, int pe);
  extern void   pshmem_put32(void *dest, const void *src, size_t nelems, int pe);
  extern void   pshmem_put64(void *dest, const void *src, size_t nelems, int pe);
  extern void   pshmem_put128(void *dest, const void *src, size_t nelems, int pe);

  extern void   pshmem_short_get(short *dest, const short *src, size_t nelems, int pe);
  extern void   pshmem_int_get(int *dest, const int *src, size_t nelems, int pe);
  extern void   pshmem_long_get(long *dest, const long *src, size_t nelems, int pe);
  extern void   pshmem_longlong_get(long long *dest, const long long *src, size_t nelems, int pe);
  extern void   pshmem_longdouble_get(long double *dest, const long double *src, size_t nelems, int pe);
  extern void   pshmem_double_get(double *dest, const double *src, size_t nelems, int pe);
  extern void   pshmem_float_get(float *dest, const float *src, size_t nelems, int pe);
  extern void   pshmem_getmem(void *dest, const void *src, size_t nelems, int pe);
  extern void   pshmem_get32(void *dest, const void *src, size_t nelems, int pe);
  extern void   pshmem_get64(void *dest, const void *src, size_t nelems, int pe);
  extern void   pshmem_get128(void *dest, const void *src, size_t nelems, int pe);
  ...
  extern void   pshmem_longdouble_p(long double *addr, long double value, int pe);
  ...
  extern void  pshmem_long_iput(long *target, const long *source, ptrdiff_t tst,
				ptrdiff_t sst, size_t nelems, int pe);

  extern void  pshmem_longdouble_iput(long double *target, const long double *source,
				      ptrdiff_t tst, ptrdiff_t sst, size_t nelems, int pe);

  extern void pshmem_longlong_iput(long long *target, const long long *source,
				   ptrdiff_t tst, ptrdiff_t sst, size_t nelems, int pe);

  extern void  pshmem_short_iput(short *target, const short *source, ptrdiff_t tst,
				 ptrdiff_t sst, size_t nelems, int pe);
  ...
  extern void  pshmem_long_iget(long *target, const long *source, ptrdiff_t tst,
				ptrdiff_t sst, size_t nelems, int pe);

  extern void  pshmem_longdouble_iget(long double *target, const long double *source,
				      ptrdiff_t tst, ptrdiff_t sst, size_t nelems, int pe);

  extern void pshmem_longlong_iget(long long *target, const long long *source,
				   ptrdiff_t tst, ptrdiff_t sst, size_t nelems, int pe);

  extern void  pshmem_short_iget(short *target, const short *source, ptrdiff_t tst,
				 ptrdiff_t sst, size_t nelems, int pe);
  ...
  extern void   pshmem_longlong_wait_until(long long *ivar, int cmp, long long cmp_value);
  ...
  extern long long   pshmem_longlong_swap(long long *target, long long value, int pe) _WUR;
  extern float       pshmem_float_swap(float *target, float value, int pe) _WUR;
  extern double      pshmem_double_swap(double *target, double value, int pe) _WUR;
  ...
  extern long        pshmem_long_cswap(long *target, long cond, long value, int pe) _WUR;
  extern long long   pshmem_longlong_cswap(long long *target,
  ...
  extern long long pshmem_longlong_fadd(long long *target, long long value, int pe) _WUR;
  ...
  extern void      pshmem_longlong_add(long long *target, long long value, int pe);
  ...
  extern void pshmem_complexf_sum_to_all(COMPLEXIFY(float) *target,
					 ...
					 long *pSync);
  extern void pshmem_double_sum_to_all(double *target,
				       double *source,
				       int nreduce,
				       int PE_start, int logPE_stride, int PE_size,
				       double *pWrk,
				       long *pSync);
  extern void pshmem_float_sum_to_all(float *target,
				      float *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      float *pWrk,
				      long *pSync);
  extern void pshmem_int_sum_to_all(int *target,
				    int *source,
				    int nreduce,
				    int PE_start, int logPE_stride, int PE_size,
				    int *pWrk,
				    long *pSync);
  extern void pshmem_long_sum_to_all(long *target,
				     long *source,
				     int nreduce,
				     int PE_start, int logPE_stride, int PE_size,
				     long *pWrk,
  ...
  extern void pshmem_longlong_sum_to_all(long long *target,
					 ...
					 long long *pWrk,
					 long *pSync);
  extern void pshmem_short_sum_to_all(short *target,
				      short *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      short *pWrk,
  ...
  extern void pshmem_complexf_prod_to_all(COMPLEXIFY(float) *target,
					  ...
					  COMPLEXIFY(float) *pWrk,
					  long *pSync);
  extern void pshmem_double_prod_to_all(double *target,
					double *source,
					int nreduce,
					int PE_start, int logPE_stride, int PE_size,
					double *pWrk,
					long *pSync);
  extern void pshmem_float_prod_to_all(float *target,
				       float *source,
				       int nreduce,
				       int PE_start, int logPE_stride, int PE_size,
				       float *pWrk,
				       long *pSync);
  extern void pshmem_int_prod_to_all(int *target,
				     int *source,
				     int nreduce,
				     int PE_start, int logPE_stride, int PE_size,
				     int *pWrk,
				     long *pSync);
  extern void pshmem_long_prod_to_all(long *target,
				      long *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      long *pWrk,
  ...
  extern void pshmem_longlong_prod_to_all(long long *target,
					  ...
					  long long *pWrk,
					  long *pSync);
  extern void pshmem_short_prod_to_all(short *target,
				       short *source,
				       int nreduce,
				       int PE_start, int logPE_stride, int PE_size,
				       short *pWrk,
  ...
  extern void pshmem_int_and_to_all(int *target,
				    ...
				    int *pWrk,
				    long *pSync);
  extern void pshmem_long_and_to_all(long *target,
				     long *source,
				     int nreduce,
				     int PE_start, int logPE_stride, int PE_size,
				     long  *pWrk,
  ...
  extern void pshmem_longlong_and_to_all(long long *target,
					 ...
					 long long *pWrk,
					 long *pSync);
  extern void pshmem_short_and_to_all(short *target,
				      short *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      short *pWrk,
  ...
  extern void pshmem_int_or_to_all(int *target,
				   ...
				   int *pWrk,
				   long *pSync);
  extern void pshmem_long_or_to_all(long *target,
				    long *source,
				    int nreduce,
				    int PE_start, int logPE_stride, int PE_size,
				    long *pWrk,
				    long *pSync);
  extern void pshmem_longlong_or_to_all(long long *target,
					long long *source,
					int nreduce,
					int PE_start, int logPE_stride, int PE_size,
					long long *pWrk,
					long *pSync);
  extern void pshmem_short_or_to_all(short *target,
				     short *source,
				     int nreduce,
				     int PE_start, int logPE_stride, int PE_size,
				     short *pWrk,
  ...
  extern void pshmem_int_xor_to_all(int *target,
				    ...
				    int *pWrk,
				    long *pSync);
  extern void pshmem_long_xor_to_all(long *target,
				     long *source,
				     int nreduce,
				     int PE_start, int logPE_stride, int PE_size,
				     long *pWrk,
  ...
  extern void pshmem_longlong_xor_to_all(long long *target,
					 ...
					 long long *pWrk,
					 long *pSync);
  extern void pshmem_short_xor_to_all(short *target,
				      short *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      short *pWrk,
  ...
  extern void pshmem_int_max_to_all(int *target,
				    ...
				    int *pWrk,
				    long *pSync);
  extern void pshmem_long_max_to_all(long *target,
				     long *source,
				     int nreduce,
				     int PE_start, int logPE_stride, int PE_size,
				     long *pWrk,
  ...
  extern void pshmem_longlong_max_to_all(long long *target,
					 ...
					 long long *pWrk,
					 long *pSync);
  extern void pshmem_short_max_to_all(short *target,
				      short *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      short *pWrk,
  ...
  extern void pshmem_longdouble_max_to_all(long double *target,
					   ...
					   long double *pWrk,
					   long *pSync);
  extern void pshmem_float_max_to_all(float *target,
				      float *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      float *pWrk,
				      long *pSync);
  extern void pshmem_double_max_to_all(double *target,
				       double *source,
				       int nreduce,
				       int PE_start, int logPE_stride, int PE_size,
				       double *pWrk,
  ...
  extern void pshmem_int_min_to_all(int *target,
				    ...
				    int *pWrk,
				    long *pSync);
  extern void pshmem_long_min_to_all(long *target,
				     long *source,
				     int nreduce,
				     int PE_start, int logPE_stride, int PE_size,
				     long *pWrk,
  ...
  extern void pshmem_longlong_min_to_all(long long *target,
					 ...
					 long long *pWrk,
					 long *pSync);
  extern void pshmem_short_min_to_all(short *target,
				      short *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      short *pWrk,
  ...
  extern void pshmem_longdouble_min_to_all(long double *target,
					   ...
					   long double *pWrk,
					   long *pSync);
  extern void pshmem_float_min_to_all(float *target,
				      float *source,
				      int nreduce,
				      int PE_start, int logPE_stride, int PE_size,
				      float *pWrk,
				      long *pSync);
  extern void pshmem_double_min_to_all(double *target,
				       double *source,
				       int nreduce,
				       int PE_start, int logPE_stride, int PE_size,
				       double *pWrk,
  ...
  extern void pshmem_broadcast32(void *target, const void *source, size_t nelems,
				 int PE_root, int PE_start, int logPE_stride, int PE_size,
				 long *pSync);

  extern void pshmem_broadcast64(void *target, const void *source, size_t nelems,
				 int PE_root, int PE_start, int logPE_stride, int PE_size,
				 long *pSync);
  ...
  extern void pshmem_fcollect32(void *target, const void *source, size_t nelems,
				int PE_start, int logPE_stride, int PE_size,
				long *pSync);
  extern void pshmem_fcollect64(void *target, const void *source, size_t nelems,
				int PE_start, int logPE_stride, int PE_size,
				long *pSync);

  extern void pshmem_collect32(void *target, const void *source, size_t nelems,
			       int PE_start, int logPE_stride, int PE_size,
			       long *pSync);
  extern void pshmem_collect64(void *target, const void *source, size_t nelems,
			       int PE_start, int logPE_stride, int PE_size,
			       long *pSync);
  ...
  extern void * pshmem_short_put_nb(short *target, const short *source, size_t nelems, int pe) _WUR;
  extern void * pshmem_int_put_nb(int *target, const int *source, size_t nelems, int pe) _WUR;
  extern void * pshmem_long_put_nb(long *target, const long *source, size_t nelems, int pe) _WUR;
  extern void * pshmem_longlong_put_nb(long long *target, const long long *source, size_t nelems, int pe) _WUR;
  extern void * pshmem_longdouble_put_nb(long double *target, const long double *source, size_t nelems, int pe) _WUR;
  extern void * pshmem_double_put_nb(double *target, const double *source, size_t nelems, int pe) _WUR;
  extern void * pshmem_float_put_nb(float *target, const float *source, size_t nelems, int pe) _WUR;
  extern void * pshmem_putmem_nb(void *target, const void *source, size_t nelems, int pe) _WUR;
  extern void * pshmem_put32_nb(void *target, const void *source, size_t nelems, int pe) _WUR;
